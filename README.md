...
- [x] Create the apps icon
- [x] Create the info/help screen
- [x] Created the weekly notfication, that sent the user how many workouts he had done in that specific week
- [x] Created the counter that shows ghow many workouts the user has had in total

### Documentations to-do list:
- [x] Create the 1st section of the documentation (Ievads)
- [x] Create the 2nd section of the documentation (Programmatūras prasību specifikācija)
- [x] Create the 3rd section of the documentation (Izstrādes līdzekļu, rīku apraksts un izvēles pamatojums)
- [x] Create the 4th section of the documentation (Sistēmas modelēšana un projektēšana)
- [x] Create the 5th section of the documentation (Lietotāju ceļvedis)
- [x] Create the 6th section of the documentation (Testēšanas dokumentācija)
- [x] Create the 7th section of the documentation (Secinājumi)
- [x] Create the 8th section of the documentation (Lietoto terminu un saīsinājumu skaidrojumi)
- [x] Create the 9th section of the documentation (Literatūras un informācijas avotu saraksts)
